...
public class BookCatalog {
    ...
    public BookCatalog() {
        ...
        bookCatalog.add(new Book("C#", Book.DOTNET, Book.ELECTRONIC));
        bookCatalog.add(new Book("Visual Basic", Book.DOTNET, Book.ELECTRONIC));
        bookCatalog.add(new Book("SQL Server", Book.DATABASE, Book.ELECTRONIC));
