	...
	public class ConsoleValidation {
		...
		public static void main(String[] args) {
			...
			String s1 = EConsole.getString("Enter any string:  ");
			System.out.println("You entered:  "+s1);
			
			// Get String - required field
			String s2 = EConsole.getString("Enter any string (req'd):  ",true);
			System.out.println("You entered:  "+s2);
			
			// Get String - only 2 valid choices
			String s3 = EConsole.getString("Enter a string (y/n):  ","y","n");
